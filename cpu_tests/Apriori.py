...
# set default minSupport to 0.3: occur in at least 50% of all transactions
def apriori(dataSet, minSupport=0.3):
    ...
    L = [L1]  # L contains the list of frequent itemsets that met a minimun support of 0.3
    k = 2
